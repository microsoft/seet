"""occluder_visualization.py

Visualization of occluder in 3D.
"""
...
class OccluderVisualization(core_visualization.NodeVisualization):
    def __init__(
        self,
        occluder,
        axes_3D,
        ...
        style_file_name=os.path.join(
            ...
            r"default_device_style/default_left_occluder_style.json"
        )
    ):
        """
        Add a visualization of Occluder to existing 3D axes.

        Args:
            occluder (Occluder): Occluder to be visualized.
