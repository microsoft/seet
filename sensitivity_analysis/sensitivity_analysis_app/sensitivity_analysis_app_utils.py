...
def generate_data_for_sensitivity_analysis(
        ...
        Args:
            scene_sampler (SceneSampler): sampler for eye-tracking scenes.
        ...
        fov_deg = scene_sampler.scene.device.display_fov / 2
        calib_list_deg = \
            [
        ...
        for scene_idx, et_scene in enumerate(scene_sampler.generate_samples()):
...
class SensitivityAnalysisAppUtils():
    ...
    def generate_data(self, input_file_name, num_samples=None):
        ...
        # used inside a loop.
        generator = generate_data_for_sensitivity_analysis(scene_sampler=scene_sampler, device=self.device)
        while True:
            try:
